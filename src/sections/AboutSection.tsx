  ...
  return (
    ...
    >
      <FadeIn delay={0.1} x={-80} y={0} duration={0.9} className="absolute top-[4%] left-[1%] sm:left-[2%] md:left-[4%]">
        <img src={DECORATIONS.moon} alt="" className="w-[120px] sm:w-[160px] md:w-[210px]" />
      </FadeIn>
      ...
      >
        <img src={DECORATIONS.object3d} alt="" className="w-[100px] sm:w-[140px] md:w-[180px]" />
      </FadeIn>

      <FadeIn delay={0.15} x={80} y={0} duration={0.9} className="absolute top-[4%] right-[1%] sm:right-[2%] md:right-[4%]">
        <img src={DECORATIONS.lego} alt="" className="w-[120px] sm:w-[160px] md:w-[210px]" />
      </FadeIn>
      ...
      >
        <img src={DECORATIONS.group} alt="" className="w-[130px] sm:w-[170px] md:w-[220px]" />
      </FadeIn>
